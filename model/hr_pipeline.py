...
# Complete RAG pipeline for HR Policy
def hr_pipeline(query):
    """Complete RAG pipeline for HR Policy."""
    # Paths
    file_path = r"source\HR_Policy.pdf"
    index_file = "embeddings/HR_policy.index"
...
# Test the HR Policy pipeline
if __name__ == "__main__":
    # Example query
    user_query = "How many annual leaves are allowed?"
    response = hr_pipeline(user_query)
    print("\n=== Answer ===\n")
