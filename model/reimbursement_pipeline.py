...
# Complete RAG pipeline for Reimbursement Policy
def reimbursement_pipeline(query):
    """Complete RAG pipeline for Reimbursement Policy."""
    # Paths
    file_path = r"source\Reimbursement_policy.pdf"
    index_file = "embeddings/Reimbursement_policy.index"
...
# Test the Reimbursement Policy pipeline
if __name__ == "__main__":
    # Example query
    user_query = "What is the per mile rate for reimbursement for the Employees using personal vehicles for business travel?"
    response = reimbursement_pipeline(user_query)
    print("\n=== Answer ===\n")
